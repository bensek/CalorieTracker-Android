...
import com.amalitech.tracker_presentation.tracker_overview.Meal
                ...
                Row(
                    ...
                    Icon(
                        ...
                        contentDescription = if(meal.isExpanded) {
                            stringResource(id = com.amalitech.core.R.string.collapse)
                        } else stringResource(id = com.amalitech.core.R.string.extend)
                    )
                }
                ...
                Row(
                    ...
                    Row {
                        ...
                        NutrientInfo(
                            ...
                            amount = meal.fat,
                            unit = stringResource(id = com.amalitech.core.R.string.fat)
                        )
                    }
                }

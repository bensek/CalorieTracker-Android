...
fun ActivityScreen(
    ...
    Box(
        ...
        Column(
            ...
            Text(
                text = stringResource(id = com.amalitech.core.R.string.whats_your_activity_level),
            ...
            Row {
                SelectableButton(
                    text = stringResource(id = com.amalitech.core.R.string.low),
                ...
                SelectableButton(
                    text = stringResource(id = com.amalitech.core.R.string.medium),
                ...
                Spacer(modifier = Modifier.width(spacing.spaceMedium))
                SelectableButton(
                    text = stringResource(id = com.amalitech.core.R.string.high),
